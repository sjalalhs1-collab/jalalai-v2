import test from 'node:test';import assert from 'node:assert/strict';import {AgentRegistry} from '../src/agents/registry.js';import {Planner} from '../src/core/planner.js';import {Verifier} from '../src/verification/verifier.js';
